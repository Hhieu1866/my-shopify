...
export function CartLineItem({
  ...
  return (
    <div className="flex gap-4 border-b border-x-gray-100 py-6">
      {/* product image */}
      <div className="relative size-24 overflow-hidden rounded-lg bg-gray-50">
        {image && (
          <Image
            alt={title}
            aspectRatio="1/1"
      ...
      <div className="min-w-0 flex-1">
        <Link
          ...
          className="block"
        >
          <h3 className="mb-1 truncate font-playfair text-base text-brand-navy">
            {product.title}
          </h3>
        </Link>
